      ...
      <div className="max-w-5xl mx-auto px-6 py-8">
        ...
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <p className="text-sm text-gray-500 mt-1">{recordings.length} recordings saved</p>
          </div>
        </div>
        ...
        {loading ? (
          ...
          <div className="bg-white rounded-xl border border-gray-200 p-12 text-center">
            ...
            <p className="text-gray-300 text-xs mt-1">Recordings are saved automatically during calls.</p>
          </div>
        ) : (
                ...
                <div className="flex items-start justify-between mb-3">
                  <div>
                    <p className="font-semibold text-gray-800">
                      {rec.contacts?.name || 'Unknown contact'}
                    </p>
                  ...
                  <div className="text-right">
                    ...
                    <p className="text-xs text-gray-400 mt-0.5">
                      Duration: ~{Math.round(rec.duration / 60)}m {rec.duration % 60}s
                    </p>
                    <button
